...
const steps = [
  {
    ...
    icon: Brain,
    title: "Ensinar",
    subtitle: "Ensine sobre sua empresa",
    desc: "Seus agentes precisam conhecer seu negócio. Cole a URL do site ou envie documentos para dar contexto real.",
    cta: "Ensinar agora",
    color: "from-blue-500/20 to-blue-500/5",
    borderColor: "border-blue-500/30",
    activeGlow: "shadow-[0_0_30px_hsl(210_100%_50%/0.15)]",
  },
  {
    id: "hire",
    number: 2,
    ...
    desc: "Escolha agentes especializados na Biblioteca — SDR, Copywriter, Analista, ou squads completos por departamento.",
    cta: "Ir à Biblioteca",
    color: "from-emerald-500/20 to-emerald-500/5",
    borderColor: "border-emerald-500/30",
    activeGlow: "shadow-[0_0_30px_hsl(150_100%_40%/0.15)]",
  },
  {
    id: "command",
    number: 3,
    icon: Zap,
    title: "Comandar",
    subtitle: "Dê a primeira missão",
    desc: "Use o Command Center para dar tarefas aos agentes. Eles executam, reportam e aprendem com cada interação.",
    cta: "Abrir Command Center",
    color: "from-primary/20 to-primary/5",
    borderColor: "border-primary/30",
    activeGlow: "shadow-[0_0_30px_hsl(var(--primary)/0.15)]",
  },
];
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4 relative">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-display text-base font-bold">3 passos para começar</h3>
            <p className="text-[10px] text-muted-foreground">
              {completedSteps}/{steps.length} concluídos • {isComplete ? "🎉 Pronto!" : "Continue de onde parou"}
            </p>
          </div>
        </div>
            ...
            <motion.div
              ...
              className={cn(
                ...
                completed
                  ...
                  : isNext
                  ? cn("bg-gradient-to-br", step.color, step.borderColor, step.activeGlow)
            ...
            >
              ...
              <div className="absolute -top-2.5 -left-1">
                <div className={cn(
                  ...
                  completed ? "bg-emerald-500 text-white" : isNext ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"
                )}>
              ...
              <div className="pt-2 space-y-2.5">
                <div className="flex items-center gap-2">
                  <Icon className={cn("h-4 w-4", completed ? "text-emerald-400" : isNext ? "text-foreground" : "text-muted-foreground")} />
                  <span className={cn("text-sm font-bold", completed && "line-through text-emerald-400/70")}>{step.title}</span>
                </div>
