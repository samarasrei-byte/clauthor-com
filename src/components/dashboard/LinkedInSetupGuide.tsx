...
import {
  Globe, ExternalLink, CheckCircle, Circle, Loader2, Shield,
...
const LinkedInSetupGuide = () => {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success("LinkedIn conectado! Credenciais salvas no cofre. 🎉");
      markComplete(5);
    },
