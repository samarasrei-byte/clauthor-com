...
import { Inbox, Layers3, KanbanSquare, FolderOpen, CheckSquare, Workflow } from "lucide-react";
...
export type WorkspaceTab = "inbox" | "squads" | "kanban" | "files" | "approvals" | "mission-composer";
...
const WorkspaceHub = ({ defaultTab = "inbox", onNavigate, onSelectAgent }: Props) => {
