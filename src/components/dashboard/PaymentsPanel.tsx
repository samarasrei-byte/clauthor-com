...
const PaymentsPanel = ({ totalRevenue, subscriptionCount }: PaymentsPanelProps) => {
  const gateways = [
    {
      name: "PIX",
      description: "Pagamentos instantâneos via PIX — Brasil",
      icon: QrCode,
      status: "active",
      ...
      volume: "R$ " + (totalRevenue * 0.6 / 100).toLocaleString("pt-BR"),
      share: 60,
    ...
    },
    {
      ...
      volume: "R$ " + (totalRevenue * 0.25 / 100).toLocaleString("pt-BR"),
      share: 25,
    ...
    },
    {
      ...
      volume: "—",
      share: 0,
      features: ["Visa & Mastercard", "Amex & Elo", "Parcelamento"],
    },
  ];
