...
const typeConfig: Record<string, { icon: typeof Bell; color: string }> = {
  ...
  agent_hired: { icon: Bot, color: "text-success" },
  email_sent: { icon: Zap, color: "text-success" },
  email_queued: { icon: Bell, color: "text-warning" },
  token_limit_80: { icon: Info, color: "text-warning" },
        ...
        <ScrollArea className="max-h-[400px]">
          {notifications.length === 0 ? (
            <div className="py-12 text-center">
              <Bell className="h-8 w-8 text-muted-foreground/60 mx-auto mb-3" />
