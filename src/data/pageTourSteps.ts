import type { PageTourStep } from "@/components/ThorPageTour";

export const FULL_PLATFORM_TOUR: PageTourStep[] = [
  {
    route: "/",
    label: "Home",
  ...
  },
  {
    route: "/pricing",
    label: "Pricing",
    pageTitle: "Planos & Preços",
    speech:
      "Aqui nos planos você vê que a gente usa um modelo baseado em créditos. Começa grátis com 50 créditos, e depois escolhe o plano que faz sentido pro seu volume. A economia comparada com equipe humana chega a 85%!",
  },
  {
    route: "/how-it-works",
    label: "Como Funciona",
    ...
    speech:
      "Nessa página eu explico o passo a passo: você ensina sobre sua empresa, escolhe os agentes, e eu orquestro tudo com autonomia inteligente. Os agentes aprendem continuamente e se adaptam ao seu negócio.",
  },
  {
    route: "/team-builder",
    label: "Team Builder",
    pageTitle: "Monte seu Time",
    speech:
      "O Team Builder é uma ferramenta interativa onde você monta sua equipe de IA personalizada. Escolhe os agentes, define prioridades, e eu calculo o custo total com o ROI estimado. É como montar seu Avengers de IA!",
  },
  {
    route: "/",
    label: "Começar",
