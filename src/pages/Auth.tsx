...
import { Bot, ArrowRight, Eye, EyeOff, Loader2, ShoppingCart, Shield, Zap, Users, Scale, CheckCircle2, TrendingDown, Lock } from "lucide-react";
    ...
    try {
      if (isLogin) {
        ...
        if (error) {
          ...
          // P1 · jornada canônica: signup sempre vai para /welcome, exceto
          // quando há redirect explícito (?redirect=...) ou o usuário já
          // tinha um destino salvo por um clique em rota protegida.
