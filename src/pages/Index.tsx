  ...
  return (
    <div className="light relative overflow-x-hidden bg-background text-foreground">
      ...
      <section aria-label="Integrações e infraestrutura" className="border-y border-border/60 bg-card/30">
        <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-5 sm:gap-10">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-primary/25 bg-primary/[0.06] text-[11px] font-mono uppercase tracking-[0.16em] text-primary/90 shrink-0">
