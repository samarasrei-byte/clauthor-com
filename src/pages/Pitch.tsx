...
const investorConversation = [
  ...
  { role: "agent" as const, text: "Porque estamos no ponto de inflexão. 75 agentes já operacionais, infraestrutura pronta e um mercado de US$ 1.8T até 2030. Você entra antes da escala explodir." },
...
const Pitch = () => {
  ...
  const indicators = [
    { icon: Bot, label: "75 agentes operacionais" },
  ...
  const advantages = [
    { icon: Bot, text: "75 agentes já operacionais" },
