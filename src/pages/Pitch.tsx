...
const investorConversation = [
  ...
  { role: "agent" as const, text: "Porque estamos no ponto de inflexão. 44 agentes já operacionais, infraestrutura pronta e um mercado de US$ 1.8T até 2030. Você entra antes da escala explodir." },
