...
import { Bot, Clock, Shield, Globe, Headphones, Receipt, Code, Scale, Brain, UserCheck, TrendingUp, Zap, Lock, Users, Layers, ArrowRight } from "lucide-react";
...
const Pitch = () => {
  ...
  const indicators = [
    { icon: Bot, label: "44 agentes operacionais" },
  ...
  const advantages = [
    { icon: Bot, text: "44 agentes já operacionais" },
  ...
  const handleDeck = useCallback(() => {
    window.open("https://wa.me/5511999999999?text=Gostaria%20de%20receber%20o%20deck%20completo%20da%20CLAUTHOR", "_blank");
  }, []);
  const handleTalk = useCallback(() => {
    window.open("https://wa.me/5511999999999?text=Gostaria%20de%20agendar%20uma%20conversa%20sobre%20investimento", "_blank");
  }, []);
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary/30">
      ...
      <div ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          <motion.p
            ...
            className="text-xs uppercase tracking-[0.3em] text-primary/70 mb-6 font-mono"
          >
          ...
          >
            <Button size="lg" onClick={handleDeck} className="text-base px-8">
              Solicitar Deck Completo <ArrowRight className="ml-1 w-4 h-4" />
            </Button>
            <Button size="lg" variant="outline" onClick={handleTalk} className="text-base px-8">
              Agendar Conversa
            </Button>
          </motion.div>
        </motion.div>
      ...
      <Section className="bg-white/[0.01]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-display font-bold mb-6 tracking-tight">
            Empresas são ineficientes por natureza.
          </h2>
          ...
          <GlassCard hover={false} className="max-w-md mx-auto text-center !py-10">
            ...
            <p className="text-sm text-muted-foreground">
              das tarefas operacionais podem ser automatizadas com IA.
            </p>
          </GlassCard>
        </div>
      </Section>
      ...
      <Section>
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-display font-bold mb-4 tracking-tight">
            Infraestrutura multiagente coordenada.
          </h2>
          <p className="text-muted-foreground text-lg mb-14 max-w-2xl mx-auto">
            A CLAUTHOR substitui departamentos por squads de IA especializados.
          </p>
      ...
      <Section className="bg-white/[0.01]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-display font-bold mb-14 tracking-tight">
            O maior shift operacional da história corporativa.
          </h2>
      ...
      <Section>
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-display font-bold mb-14 tracking-tight text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                SaaS B2B com assinatura mensal por squad. Receita previsível, LTV alto e expansão natural via upsell de agentes adicionais.
              </p>
            </div>
            <div className="space-y-4">
              <GlassCard hover={false} className="text-center !py-8">
                ...
                <p className="text-3xl md:text-4xl font-display font-bold text-primary">
                  R$ <CountUp end={997} suffix="K" /><span className="text-base font-normal text-muted-foreground">/mês</span>
                </p>
              </GlassCard>
              <GlassCard hover={false} className="text-center !py-8">
                ...
                <p className="text-3xl md:text-4xl font-display font-bold">
                  R$ <CountUp end={11.96} suffix="M" decimals={2} />
                </p>
              </GlassCard>
      ...
      <Section className="bg-white/[0.01]">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div className="inline-block px-4 py-1.5 rounded-full border border-primary/30 bg-primary/5 text-primary text-xs font-mono uppercase tracking-widest mb-6">
            Rodada aberta
          </motion.div>
          <h2 className="text-3xl md:text-5xl font-display font-bold mb-14 tracking-tight">
            Pré-Seed Aberto
        ...
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-display font-bold leading-tight tracking-tight mb-8">
            ...
            <span className="bg-gradient-to-r from-primary to-accent-violet bg-clip-text text-transparent">
              É a camada operacional da nova economia.
            </span>
          </h2>
          <div className="flex flex-wrap justify-center gap-3">
            {["Primeiro 1.000 clientes", "Rodada Seed", "Expansão internacional", "Infraestrutura global de agentes"].map((step) => (
              <span key={step} className="px-4 py-2 rounded-full border border-white/[0.06] bg-white/[0.02] text-xs text-muted-foreground">
                {step}
              </span>
            ))}
          </div>
      ...
      <section className="relative py-32 px-6">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-display font-bold mb-8 tracking-tight">
            Estamos abrindo 10% da empresa para acelerar exponencialmente.
          </h2>
          ...
          <p className="mt-8 text-xs text-muted-foreground/50">
            Documento confidencial. Distribuição restrita a potenciais investidores.
          </p>
        </div>
      </section>
    </div>
