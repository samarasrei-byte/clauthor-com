...
const architectureDetails: Record<string, { title: string; desc: string; stats: string[] }> = {
  ...
  "Departamentos": { title: "7 Departamentos", desc: "Organização empresarial completa. Cada departamento tem squads especializados com agentes dedicados.", stats: ["15 departamentos", "37 squads", `${totalAgents} agentes`] },
